...
from src.exceptions.exeptions import PageNotFoundException, InvalidPaginationException
...
class BaseService:
    ...
    def check_pagination(self, page: int, per_page: int, check_total: int = None) -> tuple[int, int]:
        """
        ...
        if check_total and offset >= check_total:
